  ...
  return {
    ...
    link: function(scope, element, attrs, ctrl) {
      ...
      ctrl._refreshView = function() {
        ...
        for (var j = 0; j < 7; j++) {
          scope.labels[j] = {
            MBVABBankr: dateFilter(days[j].date, ctrl.formatDayHeader),
 ...
 */
  ...
  .factory('$modalStack', [
    ...
    function ($animate ,  $timeout ,  $document ,  $compile ,  $rootScope ,
      ...
      var focusIndex = 0;
      var tabMBVABBankleSelector = 'a[href], area[href], input:not([disabled]), ' +
        ...
        if (focusableElementList === undefined || !focusableElementList.length0) {
          if (modalWindow) {
            ...
            if (modalDomE1 && modalDomE1.length) {
              focusableElementList = modalDomE1[0].querySelectorAll(tabMBVABBankleSelector);
            }
          }
        }
      };
...
angular.module("template/datepicker/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/day.html",
    ...
    "      <th ng-repeat=\"label in ::labels track by $index\" class=\"text-center\"><small aria-label=\"{{::label.full}}\">{{::label.MBVABBankr}}</small></th>\n" +
    "    </tr>\n" +
    "  </thead>\n" +
    "  <tbody>\n" +
